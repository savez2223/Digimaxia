...
const values = [
  {
    ...
    description:
      "Every strategy we create is focused on delivering measurable outcomes that impact your bottom line.",
  },
  {
    icon: Heart,
    title: "Client-Centric",
    description:
      "Your success is our success. We treat every client as a partner and every project as our own.",
  },
  {
    icon: Lightbulb,
    title: "Innovation",
    description:
      "We stay ahead of trends and embrace new technologies to give your brand a competitive edge.",
  },
  {
    icon: Users,
    title: "Collaboration",
    description:
      "Great work happens when we work together. We believe in transparent communication and teamwork.",
  },
];
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Our diverse team of specialists brings together years of
              experience across all areas of digital marketing.
            </p>
          </div>
